...
import Content from "../../Comps/TermsConditions/Content";
...
const TermsConditions = ({ termsIntroImageWrapperRef, termsIntroHeadingWrapperRef, termsIntroHeadingRef, headerRef, humburgerRef, toggleNewsletterPopup }) => {
    ...
    const getScrollThumbHeight = () => {
        ...
        if (scrollTrackRef.current && contentRef.current) {
            ...
            scrollThumbRef.current.style.height = `${thumbHeight + 10}px`
    ...
    return (
        <>
            <Head>
                <title>Beloved Joy | Terms & Conditions</title>
            </Head>
            ...
            <div ref={scrollerRef} className="page">
                ...
                <div className="components-wrapper">
                    ...
                    <div className="c-privacy-policy">
                        ...
                        <div ref={contentRef} className="c-privacy-policy__content__wrapper position-relative w-100 h-100 p-md-0 py-2 px-1 ">
