...
const Accessories = ({ accessoriesData, products, headerRef, humburgerRef, }) => {

    const viewAll = products.filter(({ category }) => category.indexOf("accessories") !== -1);
    const earings = products.filter(({ category }) => category.indexOf("earing") !== -1);
    const rings = products.filter(({ category }) => category.indexOf("ring") !== -1);
    const necklace = products.filter(({ category }) => category.indexOf("necklace") !== -1);
