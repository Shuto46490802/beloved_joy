...
const Clothing = ({ clothingData, products, headerRef, humburgerRef, }) => {

    const viewAll = products.filter(({ category }) => category.indexOf("clothing") !== -1);
    const top = products.filter(({ category }) => category.indexOf("top") !== -1);
    const bottom = products.filter(({ category }) => category.indexOf("bottom") !== -1);
    const intimates = products.filter(({ category }) => category.indexOf("intimates") !== -1);
