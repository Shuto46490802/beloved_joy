        ...
        <div className="c-privacy-policy__content">
            ...
            <div ref={addToSectionRefs} className={`mb-md-4 mb-1 ${isTextWrapperOpen1 ? "is-active" : ""}`} >
                ...
                <div ref={addToTextWrapperRefs} className="text-wrapper d-md-none d-block" >
                    ...
                    Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from <Link ariaLabel="home" href="/"><a>https://beloved-joy-raigmtw0j-shuto46490802.vercel.app/privacy/terms-conditions</a></Link>
                    </p>
            ...
            <div ref={addToSectionRefs} className={`mb-md-4 mb-1 ${isTextWrapperOpen3 ? "is-active" : ""}`} >
                ...
                <div ref={addToTextWrapperRefs} className="text-wrapper d-md-none d-block">
                    ...
                    <ul >
                        ...
                        <li>
                            <p><strong>Website</strong> refers to My Site, accessible from <Link ariaLabel="home" href="/"><a rel="external nofollow noopener" target="_blank">https://beloved-joy-raigmtw0j-shuto46490802.vercel.app/</a></Link></p>
                        </li>
                        <li>
