            ...
            <div ref={addToSectionRefs} className={`mb-md-4 mb-1 ${isTextWrapperOpen3 ? "is-active" : ""}`} >
                ...
                <div ref={addToTextWrapperRefs} className="text-wrapper d-md-none d-block">
                    ...
                    <ul >
                        ...
                        <li>
                            <p><strong>Website</strong> refers to My Site, accessible from <Link ariaLabel="home" href="/"><a rel="external nofollow noopener" target="_blank">https://beloved-joy.vercel.app/</a></Link></p>
                        </li>
                        <li>
