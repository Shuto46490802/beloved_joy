...
const Philosophy = ({ getScrollProxy }) => {
    ...
    return (
        <div className="c-about-philosophy d-flex flex-wrap overflow-hidden">

            <div className="background blue" />

            <div className="c-about-philosophy__content__wrapper text col-md-6 d-md-flex flex-wrap align-items-center position-relative order-md-0 order-1">
            ...
            <div ref={imageWrapperRef} className="c-about-philosophy__content__wrapper image col-md-6 col">

                <div className="overflow-hidden h-100">

                    <div className="c-about-philosophy__image position-relative should-animate">
                        ...
                        <div className="parallax-wrapper">
                            ...
                            <div ref={imageParallaxRef} className="parallax">
                                ...
                                <figure ref={imageRef} className="fig-wrapper should-animate">
                                    ...
                                    <Image src={img5} layout="fill" alt="" />
